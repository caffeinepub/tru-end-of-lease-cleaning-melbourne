  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        body: ['"General Sans"', '"Cabinet Grotesk"', "system-ui", "sans-serif"],
      ...
      colors: {
        ...
        brand: {
          ...
          "amber-dark": "oklch(var(--brand-amber-dark))",
      ...
      boxShadow: {
        ...
        card: "0 4px 20px -4px rgba(0,80,100,0.12), 0 2px 8px -2px rgba(0,80,100,0.08)",
        hero: "0 8px 40px -8px rgba(0,80,100,0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
